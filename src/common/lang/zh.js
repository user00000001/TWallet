export default {
  common: {
    ...
    enterIdentityPassword: '请输入TST ID密码',
    password: '密码',
  ...
  ledgerWallet: {
    ...
    info: 'Ledger钱包信息',
    connectApp: '请连接您的ledger设备并打开TST app.',
    status: '设备状态',
    labelEmpty: '钱包名称不能为空.',
  ...
  nodeMgmt: {
    ...
    units: '授权质押份数',
    stakeAmountTip: '质押数额 = 份数 * 500 TST/每份.',
    stakeAmount: '质押数额',
    submit: '提交',
    ...
    hasClaimableInitPos: '您还有可提取的初始质押。请先提取该部分TST。',
    noClaimbleToRefund: '没有可提取的TST。无法提款。'
  },
  exchange: {
    exchange: 'Exchange',
    changelly: 'Changelly',
